  ...
  return (
    <div className="match-container">
      ...
      <div className="match-stat">
        {[matchData.redTeamA, matchData.redTeamB, matchData.redTeamC, matchData.blueTeamA, matchData.blueTeamB, matchData.blueTeamC].map((team, index) => (
          <React.Fragment key={team.teamNumber}>
            <div className={`team ${team.teamNumber === teamNumber ? "highlight" : ""} ${index < 3 ? "dark-ftc-red" : "dark-ftc-blue"}`}>
              {getTeamRank(team)}
            </div>
